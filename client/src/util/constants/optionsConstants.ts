...
export const VERB_ENGLISH = 'VERB_ENGLISH';
export const VERB_ENGLISH_CONJUGATION = 'VERB_ENGLISH_CONJUGATION';

export const VERB_JAPANESE = 'VERB_JAPANESE';
export const VERB_JAPANESE_CONJUGATION = 'VERB_JAPANESE_CONJUGATION';

// noun types

export const NOUN_ENGLISH = 'NOUN_ENGLISH';
export const NOUN_ENGLISH_CONJUGATION = 'NOUN_ENGLISH_CONJUGATION';
export const NOUN_ENGLISH_POLARITY = 'NOUN_ENGLISH_POLARITY';
export const NOUN_ENGLISH_INDEFINITE_ARTICLE = 'NOUN_ENGLISH_INDEFINITE_ARTICLE';

export const NOUN_JAPANESE = 'NOUN_JAPANESE';
export const NOUN_JAPANESE_CONJUGATION = 'NOUN_JAPANESE_CONJUGATION';
export const NOUN_JAPANESE_TOPIC_PARTICLE = 'NOUN_JAPANESE_TOPIC_PARTICLE';
export const NOUN_JAPANESE_CATEGORY_ENDING = 'NOUN_JAPANESE_CATEGORY_ENDING';
