...
export const VERB_ENGLISH_POLARITY = 'VERB_ENGLISH_POLARITY';
...
export const ENGLISH_CONJUGATION = 'ENGLISH_CONJUGATION';
...
export const CONJUGATION_TYPE_ENGLISH = 'CONJUGATION_TYPE_ENGLISH';
export const CONJUGATION_TYPE_JAPANESE = 'CONJUGATION_TYPE_JAPANESE';
