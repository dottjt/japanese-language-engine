...
//     const { politenessArray, polarityArray,/* tense,*/ genderArray, questionArray } = preOptions;
...
//       switch(controlPanelType) {
//         case POLITENESS_CONTROL_PANEL_TYPE: 
//           return value === politenessArray ? { value, selected: true } : { value, selected: false };
//         case POLARITY_CONTROL_PANEL_TYPE:  
//           return value === polarityArray ? { value, selected: true } : { value, selected: false };
//         case TENSE_CONTROL_PANEL_TYPE:   
//           return value === japaneseTense ? { value, selected: true } : { value, selected: false };
//         case GENDER_CONTROL_PANEL_TYPE:     
//           return value === genderArray ? { value, selected: true } : { value, selected: false };
//         case QUESTION_CONTROL_PANEL_TYPE:   
//           return value === questionArray ? { value, selected: true } : { value, selected: false };
//       }
//       throw new Error(createError('SentenceControlPanel.tsx', 'convertValues', `${controlPanelType} does not exist.`));    
//     });
