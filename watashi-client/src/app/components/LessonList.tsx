    ...
    return (
      <React.Fragment>
        ...
        <FlexColumn>
          ...
          <SidebarItem routeName={LESSON_TITLE.L021} routeOptions={{reload: true}}>{LESSON_TITLE.L021}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L022} routeOptions={{reload: true}}>{LESSON_TITLE.L022}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L023} routeOptions={{reload: true}}>{LESSON_TITLE.L023}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L024} routeOptions={{reload: true}}>{LESSON_TITLE.L024}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L025} routeOptions={{reload: true}}>{LESSON_TITLE.L025}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L026} routeOptions={{reload: true}}>{LESSON_TITLE.L026}</SidebarItem>
        </FlexColumn>

        <FlexColumn>
          <HeadingItem>{LESSON_SECTIONS.S06}</HeadingItem>
          <SidebarItem routeName={LESSON_TITLE.L027} routeOptions={{reload: true}}>{LESSON_TITLE.L027}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L028} routeOptions={{reload: true}}>{LESSON_TITLE.L028}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L029} routeOptions={{reload: true}}>{LESSON_TITLE.L029}</SidebarItem>
          <SidebarItem routeName={LESSON_TITLE.L030} routeOptions={{reload: true}}>{LESSON_TITLE.L030}</SidebarItem>
        </FlexColumn>
      </React.Fragment>
    );
  };
