...
const determineVerbConjugationHelpingEnglish = (verb: Util.Verb, context: Util.SentenceContext): Util.WordArrayElement[] => {
  ...
  throw new Error(createError('verbConjugationHelpingEnglish', 'determineVerbConjugationHelpingEnglish', `${eventOccurance}${eventDuration}${eventPOV} unknown`));  
}
