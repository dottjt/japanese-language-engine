  ...
  if (permissions) {
    ...
    if (topicIntent === CONTEXT_INTENT_EXISTENCE) {
      switch(`${eventOccurance}${eventDuration}${eventPOV}`) {
        ...
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "was" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "were" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "was" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "were" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "were" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "were" ], TENSE_SIMPLE_PAST);
        
        // Simple Present - "Happening all the time, or exist now"
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "am" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "are" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "is" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "are" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "are" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "are" ], TENSE_SIMPLE_PRESENT);
      }
    }
    ...
    if (topicIntent === CONTEXT_INTENT_POSSESSION) {
      switch(`${eventOccurance}${eventDuration}${eventPOV}`) {
        // Simple Past - Event that describes an event or action that happened in the past.     
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "had" ], TENSE_SIMPLE_PAST);
        
        // Simple Present - "Happening all the time, or exist now"
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "have" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "have" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "has" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "have" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "have" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "have" ], TENSE_SIMPLE_PRESENT);
      }
    }
    ...
    if (topicIntent === CONTEXT_INTENT_ACTION) {
      switch(`${eventOccurance}${eventDuration}${eventPOV}`) {
        // Simple Past - Event that describes an event or action that happened in the past.
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "did" ], TENSE_SIMPLE_PAST);
        
        // Simple Present - Happening all the time, or exist now
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "do" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "do" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "does" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "do" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "do" ], TENSE_SIMPLE_PRESENT);
        case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "do" ], TENSE_SIMPLE_PRESENT);
      }
    }
    ...
    switch(`${eventOccurance}${eventDuration}${eventPOV}`) {
      ...
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "was" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "were" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "was" ], TENSE_PAST_CONTINUOUS); 
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "were" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "were" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "were" ], TENSE_PAST_CONTINUOUS);
      ...
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "have", "been" ], TENSE_SIMPLE_PAST);
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "has", "been" ], TENSE_SIMPLE_PAST);
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "have", "been" ], TENSE_SIMPLE_PAST);
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "have", "been" ], TENSE_SIMPLE_PAST);
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "have", "been" ], TENSE_SIMPLE_PAST);
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "have", "been" ], TENSE_SIMPLE_PAST);
      ...
      case `${CONTEXT_EVENT_OCCURANCE_PAST_NOW}${CONTEXT_EVENT_DURATION_SINGLE}${CONTEXT_POV_HESHEIT_SINGULAR}`: // should this maybe be has?
      ...
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "am" ], TENSE_PRESENT_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "are" ], TENSE_PRESENT_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "is" ], TENSE_PRESENT_CONTINUOUS); 
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "are" ], TENSE_PRESENT_CONTINUOUS); 
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "are" ], TENSE_PRESENT_CONTINUOUS); 
      case `${CONTEXT_EVENT_OCCURANCE_NOW}${CONTEXT_EVENT_DURATION_CONTINUOUS}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "are" ], TENSE_PRESENT_CONTINUOUS); 
