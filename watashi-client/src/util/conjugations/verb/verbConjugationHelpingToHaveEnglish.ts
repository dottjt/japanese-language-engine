...
const determineVerbConjugationHelpingToHaveEnglish = (context: Util.SentenceContext): Util.WordArrayElement[] => {
...
// instead, I need to check if it is posession or existance.
  ...
  // happen in future - will
    ...
    switch(`${eventOccurance}${eventDuration}${eventPOV}`) {
      ...
      case `${CONTEXT_EVENT_OCCURANCE_BEFORE_PAST}${CONTEXT_EVENT_DURATION_COMPLETE}${CONTEXT_POV_THEYTHOSE_PLURAL}`:
        return createWord([ "had", "had" ], TENSE_PAST_PERFECT);
      ...
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_SELF_SINGULAR}`: return createWord([ "was", "having" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_YOU_SINGULAR}`: return createWord([ "were", "having" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_HESHEIT_SINGULAR}`: return createWord([ "was", "having" ], TENSE_PAST_CONTINUOUS); 
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_WE_PLURAL}`: return createWord([ "were", "having" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_YOU_PLURAL}`: return createWord([ "were", "having" ], TENSE_PAST_CONTINUOUS);
      case `${CONTEXT_EVENT_OCCURANCE_PAST}${CONTEXT_EVENT_DURATION_PARTIAL_CONTINUOUS}${CONTEXT_POV_THEYTHOSE_PLURAL}`: return createWord([ "were", "having" ], TENSE_PAST_CONTINUOUS);
  ...
  throw new Error(createError('verbConjugationHelpingToHaveEnglish', 'determineVerbConjugationHelpingToHaveEnglish', `${eventOccurance}${eventDuration}${eventPOV} unknown`));  
}

const verbConjugationHelpingToHaveEnglish = (words: Util.SentenceWords, modifiers: Util.SentenceWordModifiers, options: Util.Options, sentenceContext: Util.SentenceContext, sentenceType: string): Util.WordArrayElement[] => {
  return determineVerbConjugationHelpingToHaveEnglish(sentenceContext);
};

export default verbConjugationHelpingToHaveEnglish;
