...
export const CONTEXT_EVENT_JAPANESE_PAST = [
...
export const CONTEXT_EVENT_JAPANESE_PRESENT = [
...
export const CONTEXT_EVENT_DURATION_CONTINUOUS = "CONTEXT_EVENT_DURATION_CONTINUOUS";
export const CONTEXT_EVENT_DURATION_SINGLE = "CONTEXT_EVENT_DURATION_SINGLE";
...
// export const PREPOSITION_TYPE_ORIGIN = "PREPOSITION_TYPE_ORIGIN";
  ...
  //   eventDuration: 'CONTEXT_EVENT_DURATION_SINGLE',
