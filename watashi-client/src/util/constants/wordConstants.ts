...
export const SENTENCE_TYPE_PREPOSITION_BEFORE = 'SENTENCE_TYPE_PREPOSITION_BEFORE';
export const SENTENCE_TYPE_PREPOSITION_AFTER = 'SENTENCE_TYPE_PREPOSITION_AFTER';
